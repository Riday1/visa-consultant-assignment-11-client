...
const Footer = () => {
    return (
        <footer className=" divide-y bg-gray-200 dark:text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="">
                        ...
                        <p className=" text-center text-2xl font-semibold">Kopa visa consultant ltd</p>
                    </a>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">© All copy right reserved by , Ridoy Hossain</div>
        </footer>
    );
};
