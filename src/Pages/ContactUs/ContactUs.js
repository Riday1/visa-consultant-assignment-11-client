...
const ContactUs = () => {
    ...
    return (
        <section className="py-10 bg-gray-100 sm:py-16 lg:py-24 ">
            <Helmet>
                <title>contact us - kopa visa consultant</title>
                ...
                <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
                    <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                        ...
                        <div className="overflow-hidden bg-white rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium text-gray-900">rrriday100@gmail.com</p>
                                <p className="mt-1 text-lg font-medium text-gray-900">hr@gmail.com</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden bg-white rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium leading-relaxed text-gray-900">Khilkhet Dhaka, Bangladesh</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 overflow-hidden bg-white rounded-xl">
                        <div className="px-6 py-12 sm:p-12">
                            ...
                            <form onSubmit={handleSubmit} action="#" method="POST" className="mt-14">
