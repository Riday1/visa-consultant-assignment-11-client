                ...
                <div class="max-w-5xl mx-auto mt-12 sm:mt-16">
                    <div class="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                        ...
                        <div class="overflow-hidden bg-white rounded-xl">
                            <div class="p-6">
                                ...
                                <p class="mt-6 text-lg font-medium text-gray-900">rrriday100@gmail.com</p>
                                <p class="mt-1 text-lg font-medium text-gray-900">hr@gmail.com</p>
                            </div>
                        </div>
                        ...
                        <div class="overflow-hidden bg-white rounded-xl">
                            <div class="p-6">
                                ...
                                <p class="mt-6 text-lg font-medium leading-relaxed text-gray-900">Khilkhet Dhaka, Bangladesh</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 overflow-hidden bg-white rounded-xl">
                        <div class="px-6 py-12 sm:p-12">
                            ...
                            <form onSubmit={handleSubmit} action="#" method="POST" class="mt-14">
